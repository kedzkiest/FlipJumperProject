...
public class Player : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (stageManager.currentStage != collision.gameObject)
        {
            ...
            stageManager.currentStage.GetComponent<Renderer>().material.SetColor("_EmissionColor", stageManager.emissionColor * 15);
            
            stageManager.ringEffect.GetComponent<Animator>().enabled = true;
            stageManager.ringEffect.GetComponent<Renderer>().material.SetColor("_EmissionColor", stageManager.emissionColor * 2);
    ...
    private void PlayerDie()
    {
        ...
        if (isJuicy)
        {
            // play audio clip
            audioManager.audioSource.Stop();
            audioManager.onStartCrowdCheering.Stop();
