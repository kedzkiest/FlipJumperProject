...
public class ChangeStartBoxColor : MonoBehaviour
{
    ...
    IEnumerator Change_Color()
    {
        ...
        material.SetColor("_EmissionColor", Color.HSVToRGB(HSV_Hue, HSV_Saturation, HSV_Brightness) * 20);
